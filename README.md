<img align="center" src="https://github.com/sinhyeongi/sinhyeongi/blob/main/profile.png?raw=true" width="100"/>
<br>
...
### <a href="https://github.com/sinhyeongi/NewLetsAssemble_Back" style="text-decoration: none;">NewLetsAsseemble </a>
채팅 읽음 처리에서 발생하는 DB write 집중 문제를 개선하기 위해
Redis + Batch 구조로 재설계한 백엔드 프로젝트

- 읽음 요청 -> Redis -> Batch -> DB 구조 적용
- 요청 처리와 DB 반영 시점 분리
